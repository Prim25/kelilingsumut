...
const DestinationPage: React.FC = () => {
  ...
  const paginatedDestinations = destinations.slice((currentPage - 1) * 3, currentPage * 3);
    ...
    <div className="bg-gray-100 min-h-screen p-6">
      ...
      <section className="bg-white p-6 mt-6 rounded-lg shadow-md">
        ...
        <div className="flex justify-between items-center mb-6">
          <h1 className="text-3xl font-semibold text-center w-full">Destinasi</h1>
          <input
            type="text"
            placeholder="Search"
        ...
        {/* Map Section */}
        <div className="mb-6">
          <img src="/assets/peta.jpg" alt="Peta Interaktif" className="w-full h-64 object-cover rounded-lg" />
        </div>

        {/* Category Filters */}
        <div className="flex space-x-4 mb-6">
          <button className="px-4 py-2 bg-blue-600 text-white rounded-lg">Gunung</button>
          <button className="px-4 py-2 bg-blue-600 text-white rounded-lg">Pantai</button>
          <button className="px-4 py-2 bg-blue-600 text-white rounded-lg">Museum</button>
          <button className="px-4 py-2 bg-blue-600 text-white rounded-lg">Air Terjun</button>
        </div>
